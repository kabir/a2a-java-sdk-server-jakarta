package org.wildfly.extras.a2a.test.jsonrpc.compat03;
...
import org.wildfly.extras.a2a.jsonrpc.web.compat03.A2AServerResource_v0_3;
import org.wildfly.extras.a2a.jsonrpc.compat03.A2AServerResourceDelegate_v0_3;


@ArquillianTest
@RunAsClient
public class JakartaA2AServer_v0_3_JSONRPCTest extends AbstractA2AServerServerTest_v0_3 {

    public JakartaA2AServer_v0_3_JSONRPCTest() {
        super(8080);
    }
    ...
    public static WebArchive createTestArchive() throws Exception {
        ...
        final JavaArchive[] libraries = List.of(
                ...
                // a2a-java-sdk-transport-jsonrpc (v1.0, needed by jakarta-jsonrpc)
                ...
                // a2a-java-sdk-compat-0.3-client-transport-jsonrpc.jar (v0.3 JSONRPC client transport)
